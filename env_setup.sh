...
if [ "$TARGET" != "" ]; then
	echo
        ...
        echo "example: build_kernel.sh G925P"
        exit 1
fi
...
if [ "$TARGET" = "G925P" ] ; then
	export KERNEL_CONFIG="exynos7420-zeroflte_spr_defconfig";
fi;
...
# system compiler
export CROSS_COMPILE=/home/buildserver/aarch64-linux-android-4.9/bin/aarch64-linux-android-
